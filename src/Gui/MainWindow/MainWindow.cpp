...
const char COMMUNITY_FORUM_URL[] = "https://bitcointalk.org/index.php?topic=2289043.0";
const char REPORT_ISSUE_URL[] = "https://t.me/unaworld";

const char DONATION_URL_DONATION_TAG[] = "donation";
const char DONATION_URL_LABEL_TAG[] = "label";
const char DONATION_ADDRESS[] = "UNA16ve46Mo3RTpnk1UG4s57b9Ua7ChcC61vQ1rWBhzSLuyhh3Y2tasG6inPbzxcEQC8Pezms6Yd2YgzDfzN9kQ89kPJwYv18x";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("UNA Lite %1").arg(Settings::instance().getVersion()));
