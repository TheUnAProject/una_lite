...
public:
    ...
    QAction *m_aboutKarbovanetsAction;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        m_aboutKarbovanetsAction = new QAction(MainWindow);
        m_aboutKarbovanetsAction->setObjectName(QStringLiteral("m_aboutKarbovanetsAction"));
        m_aboutKarbovanetsAction->setEnabled(true);
        ...
        m_toolFrame = new QFrame(m_walletFrame);
        ...
        horizontalLayout_5 = new QHBoxLayout(m_toolFrame);
        horizontalLayout_5->setSpacing(0);
        horizontalLayout_5->setObjectName(QStringLiteral("horizontalLayout_5"));
        horizontalLayout_5->setContentsMargins(0, 15, 0, 0);
        ...
        horizontalLayout_5->addWidget(m_overviewButton);
        ...
        horizontalLayout_5->addWidget(m_sendButton);
        ...
        horizontalLayout_5->addWidget(m_receiveButton);
        ...
        horizontalLayout_5->addWidget(m_transactionsButton);
        ...
        horizontalLayout_5->addWidget(m_addressBookButton);


        verticalLayout_3->addWidget(m_toolFrame);
        ...
        menuHelp->addAction(m_aboutKarbovanetsAction);
        ...
        menuWallet->addSeparator();
        menuWallet->addAction(m_openPaymentRequestAction);
        ...
        QObject::connect(m_aboutKarbovanetsAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutKarbovanetsAction->setText(QApplication::translate("MainWindow", "About UNA Lite Wallet", nullptr));
        ...
        menuWallet->setTitle(QApplication::translate("MainWindow", "Options", nullptr));
    } // retranslateUi
