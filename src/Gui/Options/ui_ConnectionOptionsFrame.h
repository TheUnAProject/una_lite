...
public:
    ...
    void retranslateUi(QFrame *ConnectionOptionsFrame)
    {
        ...
        m_autoHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to local UNA daemon process on default port 32348. In case of no local daemon running it will use a random remote node.", nullptr));
        ...
        m_localHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to local UNA daemon process. Please specify daemon's port.", nullptr));
        ...
        m_remoteHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to UNA node running on another PC in the local or global network. Please specify IP address or domain name and the port.", nullptr));
        label_4->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet sends 0.25% fee from each transaction to the remote node it is connected to, but no more than 1 UNA.", nullptr));
    } // retranslateUi
